    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      ...
      >
        <div className="p-6 border-b border-[#333333] flex justify-between items-center bg-[#222]">
          <div>
            <h2 className="text-xl font-bold text-white uppercase italic tracking-tighter">Raw Data Ingestion</h2>
            <p className="text-[10px] text-[#888888] font-mono tracking-widest uppercase mt-1">Multi-Format Pipeline // Secure Upload</p>
          </div>
