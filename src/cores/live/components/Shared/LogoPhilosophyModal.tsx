...
export default function LogoPhilosophyModal({ isOpen, onClose }: LogoPhilosophyModalProps) {
  ...
  const elements = [
    ...
    },
    {
      ...
      desc: 'Belahan kanan yang dihiasi sirkuit tembaga neon blue dan green melambangkan AI Multi-Dimensi (Core GeoAI Pro). Lintasan data mengalir seperti energi cair, memvisualisasikan bagaimana AI memproses miliaran data sensor dari lapangan dalam hitungan milidetik secara real-time.',
